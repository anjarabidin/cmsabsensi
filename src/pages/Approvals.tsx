    ...
    return (
        <DashboardLayout>
            <div className="relative min-h-screen bg-slate-50/50">
                ...
                <div className="relative z-10 space-y-6 px-4 pt-8 pb-24 md:px-8">
                    <div className="flex items-start gap-4 text-white">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold tracking-tight drop-shadow-md">Persetujuan (Approval)</h1>
                            <p className="text-blue-50 font-medium opacity-90 mt-1">Review pengajuan cuti, lembur, dan koreksi absen.</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 text-center text-slate-500">
                        ...
                        <h3 className="text-lg font-bold text-slate-700">Modul Approval</h3>
